...
public class MasterData {
	public static CompanyDetailsDTO getCompanyDetailsDTO() 
	{
		...
		companyDetails.setStockExchange("IND");
		companyDetails.setCompanyName("Infosys");
		companyDetails.setCompanyCEO("Salil Parekh");
		companyDetails.setTurnover(65432.87);
		companyDetails.setBoardOfDirectors("Siddharth, Arun, Sikka");
		companyDetails.setCompanyProfile("Golden");
